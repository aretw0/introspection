...
- [x] Delete old tags and releases (manual, post-merge)
- [x] Re-tag as `v0.1.2` (manual, post-merge)
- [x] Verify pkg.go.dev indexing (manual, post-merge)

### ✅ Implemented (v0.1.3)

- [x] Implement primary node customization with IoC pattern.
